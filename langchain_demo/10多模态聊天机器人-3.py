...
# 最终的链,RunnablePassthrough这个函数会给两个字典，一个是你传进来的，另一个就是后面messages_summerized=summerize_messages的值成的
final_chain=(RunnablePassthrough.assign(messages_summerized=summerize_messages) | chain_with_chat_message_history )
